...
const actualizarBotones = () => {
    if (turno === 1) {
        // Habilitar botones del Jugador 1 y deshabilitar del Jugador 2
        ...
        // Habilitar botones del Jugador 2 y deshabilitar  del Jugador 1
...
document.getElementById("btn_ermi_py1").addEventListener('click', () => {
    ...
    if (contador_semilla > 0) {
        ...
        Swal.fire({
            ...
            didOpen: () => {
                document.querySelector('.swal2-popup').style.background = 'linear-gradient(to bottom right, green, gray)';
...
// Semillas del ermitaño jugador 2
