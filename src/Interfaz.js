    ...
    Swal.fire({
        ...
        html: `
            <div style="text-align: center;">
                <p style="color:rgb(229, 255, 0); font-size: 1.2rem; text-shadow: 2px 2px 4px rgba(255, 252, 252, 0.5);">Victorias Jugador 1: ${historial.victoriasJugador1}</p>
                <p style="color:rgb(0, 255, 242); font-size: 1.2rem; text-shadow: 2px 2px 4px rgba(255, 255, 255, 0.5);">Victorias Jugador 2: ${historial.victoriasJugador2}</p>
            </div>
        `,
        icon: "info",
        background: "transparent",
        backdrop: "linear-gradient(to right, rgba(49, 250, 14, 0.4), rgba(72, 0, 255, 0.4))", // Degradado azul a rosa con transparencia
        customClass: {
            popup: 'swal2-popup',
            title: 'swal2-title',
...
const revancha = () => {
    Swal.fire({
        ...
        cancelButtonText: "No",
        backdrop: "linear-gradient(to right, rgba(157, 0, 0, 0.4), rgba(0, 21, 255, 0.4))", // Degradado azul a rosa con transparencia
    }).then((result) => {
...
const iniciar_player2 = () => {
    ...
    if (aceptar === 2) {
        ...
        Swal.fire({
            title: "🔥 ¡PREPÁRATE PARA EL COMBATE! 🔥",
...
document.getElementById("btn_atk_py1").addEventListener('click', () => {
    if (player1.getKi() < 5 || player1.getEnergia() < 10) {
        ...
        Swal.fire({
            title: "Puño Sofocante!",
            text: "AUUUUUCCCCHHHHHH",
            width: 600,
            color: "#ffffff",
            background: "transparent", 
            ...
            background: "transparent", 
            backdrop: "linear-gradient(to right, rgba(0, 0, 255, 0.4), rgba(255, 20, 147, 0.4))", // Degradado azul a rosa con transparencia
        });        
        if (vidaJugador2 <= 0) {
...
document.getElementById("btn_esp_py1").addEventListener('click', () => {
    if (player1.getKi() < 20 || player1.getEnergia() < 30) {
        Swal.fire({
            ...
            backdrop: "linear-gradient(to right, rgba(0, 255, 98, 0.4), rgba(157, 20, 93, 0.4))",
            customClass: {
        ...
        if (!player1.atk_especial(player2)) {
            Swal.fire({
                ...
                color: "#d33",
                background: "transparent", // Fondo transparente
                backdrop: "linear-gradient(to right, rgba(255, 251, 6, 0.4), rgba(39, 244, 255, 0.4))",
                customClass: {
                    popup: 'swal2-popup-transparent'
                }
            });
        ...
        Swal.fire({
            ...
            width: 600,
            color: "#ffffff",
            backdrop: "linear-gradient(to right, rgba(30, 0, 255, 0.4), rgba(21, 249, 71, 0.4))",
...
document.getElementById("btn_ermi_py1").addEventListener('click', () => {
    ...
    if (contador_semilla > 0) {
        ...
        Swal.fire({
            ...
            imageHeight: 300,
            imageAlt: "curacion",
            backdrop: "linear-gradient(to right, rgba(144, 238, 144, 0.5), rgba(255, 0, 0, 0.5))", 
            customClass: {
                popup: 'custom-swal'
            },
            didOpen: () => {
...
document.getElementById("btn_ki_py1").addEventListener('click', () => {
    if (player1.getKi() >= 80) {
        ...
        Swal.fire({
            ...
            backdrop: "linear-gradient(to right, rgba(0, 191, 255, 0.5), rgba(57, 255, 20, 0.5))",
            customClass: {
                popup: 'custom-swal'
            },
            didOpen: () => {
...
document.getElementById("btn_atk_py2").addEventListener('click', () => {
    if (player2.getKi() < 5 || player2.getEnergia() < 10) {
        ...
        Swal.fire({
            title: "¡Kienzan!",
            text: "AUUUUUUCCCCCCHHHHHH",
            width: 600,
            imageUrl: `./public/img/${pj2}/basico.png`,
            imageWidth: 300,
            imageHeight: 300,
            imageAlt: "Ataque Basico",
            backdrop: "linear-gradient(to right, rgba(255, 165, 0, 0.6), rgba(8, 255, 33, 0.6))", 
            customClass: {
                popup: 'custom-swal'
            },
            didOpen: () => {
...
document.getElementById("btn_esp_py2").addEventListener('click', () => {
    if (player2.getKi() < 20 || player2.getEnergia() < 30) {
        Swal.fire({
            ...
            color: "#d33",
            background: "transparent", // Fondo transparente
            backdrop: "linear-gradient(to right, rgba(255, 0, 0, 0.4), rgba(0, 0, 255, 0.4))", // Nuevo degradado
            customClass: {
                popup: 'swal2-popup-transparent'
            }
        });
        ...
        if (!player2.atk_especial(player1)) {
            Swal.fire({
                ...
                color: "#d33",
                background: "transparent", // Fondo transparente
                backdrop: "linear-gradient(to right, rgba(0, 255, 0, 0.4), rgba(0, 255, 255, 0.4))", // Nuevo degradado
                customClass: {
                    popup: 'swal2-popup-transparent'
                }
            });
        ...
        Swal.fire({
            ...
            imageHeight: 300,
            imageAlt: "Ataque Especial",
            backdrop: "linear-gradient(to right, rgba(255, 140, 0, 0.4), rgba(255, 0, 140, 0.4))", // Nuevo degradado
            customClass: {
                popup: 'swal2-popup-transparent'
            },
            didOpen: () => {
...
document.getElementById("btn_ki_py2").addEventListener('click', () => {
    if (player2.getKi() >= 80) {
        ...
        Swal.fire({
            ...
            imageHeight: 300,
            imageAlt: "regeneracion",
            backdrop: "linear-gradient(to right, rgba(107, 251, 239, 0.6), rgba(251, 44, 158, 0.6))", 
            customClass: {
                popup: 'custom-swal'
            },
            didOpen: () => {
